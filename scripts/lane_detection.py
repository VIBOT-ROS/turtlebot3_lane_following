...
class lane_following:
    ...
    def callback(self, image_msg):
        ...
        try:
            ...
            self.lane_fit_bef = right_fit
        except:
            right_fit = self.lane_fit_bef
        ...
        # if np.all(final) is None:
        #     final = img
        # self.detect_white_lane_pub.publish(self.cvBridge.cv2_to_compressed_imgmsg(thresh, "jpg"))
